...
- Account: Account 11
- Website: https://account-11.example
- Segment: solo_consultant
- Source: demo fixture
- Confidence: high

RevOps advisor with high-value CRM cleanup projects, has a target account sheet, needs better context before outreach and weekly analytics.
...
- [ev_account_11_note_1] RevOps advisor with high-value CRM cleanup projects. (operator_note; inputs/targets.csv; confidence: medium)
- [ev_account_11_note_2] has a target account sheet. (operator_note; inputs/targets.csv; confidence: medium)
- [ev_account_11_website] Website listed for account: https://account-11.example (website; https://account-11.example; confidence: medium)
- [ev_account_11_segment] Segment from target list: solo_consultant (target_csv; inputs/targets.csv; confidence: high)
- [ev_account_11_source] Imported from source: demo fixture (target_csv; inputs/targets.csv; confidence: high)
