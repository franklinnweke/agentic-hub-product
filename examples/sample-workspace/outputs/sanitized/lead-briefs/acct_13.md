...
- Account: Account 13
- Website: https://account-13.example
- Segment: professional_services
- Source: demo fixture
- Confidence: medium

Managed services provider with local commercial prospects, renewal windows tracked manually, follow-up ownership is unclear.
...
- [ev_account_13_note_1] Managed services provider with local commercial prospects. (operator_note; inputs/targets.csv; confidence: medium)
- [ev_account_13_note_2] renewal windows tracked manually. (operator_note; inputs/targets.csv; confidence: medium)
- [ev_account_13_website] Website listed for account: https://account-13.example (website; https://account-13.example; confidence: medium)
- [ev_account_13_segment] Segment from target list: professional_services (target_csv; inputs/targets.csv; confidence: high)
- [ev_account_13_source] Imported from source: demo fixture (target_csv; inputs/targets.csv; confidence: high)
