...
- Account: Account 12
- Website: https://account-12.example
...
- [ev_account_12_note_1] Brand studio serving B2B services firms. (operator_note; inputs/targets.csv; confidence: medium)
- [ev_account_12_note_2] relies on referrals. (operator_note; inputs/targets.csv; confidence: medium)
- [ev_account_12_website] Website listed for account: https://account-12.example (website; https://account-12.example; confidence: medium)
- [ev_account_12_segment] Segment from target list: boutique_agency (target_csv; inputs/targets.csv; confidence: high)
- [ev_account_12_source] Imported from source: demo fixture (target_csv; inputs/targets.csv; confidence: high)
