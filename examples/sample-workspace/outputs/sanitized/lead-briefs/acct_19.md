...
- Account: Account 19
- Website: https://account-19.example
- Segment: professional_services
- Source: demo fixture
- Confidence: medium

Tax advisory firm with seasonal high-value prospects, deadline-driven follow-up windows, and manual referral tracking.
...
- [ev_account_19_note_1] Tax advisory firm with seasonal high-value prospects. (operator_note; inputs/targets.csv; confidence: medium)
- [ev_account_19_note_2] deadline-driven follow-up windows. (operator_note; inputs/targets.csv; confidence: medium)
- [ev_account_19_website] Website listed for account: https://account-19.example (website; https://account-19.example; confidence: medium)
- [ev_account_19_segment] Segment from target list: professional_services (target_csv; inputs/targets.csv; confidence: high)
- [ev_account_19_source] Imported from source: demo fixture (target_csv; inputs/targets.csv; confidence: high)
